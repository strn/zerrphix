...
class RawSeasonImages(RawImagesBase):
    ...
    def __init__(self, **kwargs):
        ...
        """
        super(RawSeasonImages, self).__init__(**kwargs)
    ...
    def get_tv_season_not_missing_raw_eapi_image(self, zp_tv_id, eapi, zp_lang_id):
        session = self.Session()
        return_dict = {}
        query_tv_season_not_missing_raw_eapi_image = session.query(TABLES.ZP_TV_SEASON_RAW_IMAGE).filter(
            TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_LANG_ID == zp_lang_id,
            TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID == zp_tv_id,
            TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_EAPI_ID == self.eapi_dict[eapi]
        )
        ...
        if query_tv_season_not_missing_raw_eapi_image_count > 0:
            tv_season_not_missing_raw_eapi_image = query_tv_season_not_missing_raw_eapi_image.order_by(
                TABLES.ZP_TV_SEASON_RAW_IMAGE.SEASON.asc(),
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID.asc()
            ).all()
            session.close()
            for tv_season_image in tv_season_not_missing_raw_eapi_image:
                ...
                if tv_season_image.ZP_ENTITY_TYPE_ID not in return_dict[tv_season_image.SEASON]:
                    return_dict[tv_season_image.SEASON].append(tv_season_image.ZP_ENTITY_TYPE_ID)
        return return_dict
    ...
    def get_tv_not_in_raw_eapi_image_no_retry(self, zp_tv_id, eapi, zp_lang_id, zp_entity_id_list):
        ...
        qry_tv_missing_raw_eapi_image = session.query(
            ...
            ~TABLES.ZP_TV_EAPI_EID.ZP_TV_ID.in_(session.query(
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID.distinct().label('ZP_ENTITY_ID')).filter(
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID.in_(zp_entity_id_list),
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_EAPI_ID == TABLES.ZP_TV_EAPI_EID.ZP_EAPI_ID,
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_LANG_ID == zp_lang_id
            ).group_by(
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID
            ).having(
                #func.count(TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID.distinct().label('ZP_ENTITY_TYPE_ID')) ==
                #len(zp_entity_id_list)
                func.count() == session.query(
                    func.count(TABLES.ZP_TV_EPISODE.SEASON.distinct()).label('E_COUNT')).filter(
            ...
            ~TABLES.ZP_TV_EAPI_EID.ZP_TV_ID.in_(session.query(
                ...
                TABLES.ZP_RETRY.ZP_RETRY_ENTITY_TYPE_ID == 10,
        ...
        tv_missing_raw_eapi_image = qry_tv_missing_raw_eapi_image.order_by(TABLES.ZP_TV_EAPI_EID.ZP_TV_ID.desc()).limit(50)
        session.close()
    ...
    def get_tv_not_in_raw_eapi_image_retry(self, zp_tv_id, eapi, zp_lang_id, zp_entity_id_list):
        ...
        qry_tv_missing_raw_eapi_image = session.query(
            ...
            ~TABLES.ZP_TV_EAPI_EID.ZP_TV_ID.in_(session.query(
                ...
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID,
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID
            ).having(
                #func.count(TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID.distinct().label('ZP_ENTITY_TYPE_ID')) <
                #len(zp_entity_id_list)
                func.count() == session.query(func.count(TABLES.ZP_TV_EPISODE.SEASON.distinct()).label('E_COUNT')).filter(
                    TABLES.ZP_TV_EPISODE.ZP_TV_ID == TABLES.ZP_TV_EAPI_EID.ZP_TV_ID
                ).correlate(TABLES.ZP_TV_EAPI_EID).as_scalar() * len(zp_entity_id_list)
            )),
    ...
    def get_tv_missing_raw_eapi_image_no_retry(self, zp_tv_id, eapi, zp_lang_id, zp_entity_id_list):
        ...
        #        ~TABLES.ZP_TV.ID.in_(
        #            session.query(TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID).filter(
        #                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID.in_(zp_entity_id_list),
        #                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_EAPI_ID == self.eapi_dict[eapi],
        #                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_LANG_ID != zp_lang_id,
        #                TABLES.ZP_TV_SEASON_RAW_IMAGE.SEASON == TABLES.ZP_TV_EPISODE.SEASON
        #            ).group_by(
        #                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID,
        #                TABLES.ZP_TV_SEASON_RAW_IMAGE.SEASON
        #            ).having(
        #                func.count(TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID) == len(zp_entity_id_list))
        #        ),
        #        ~TABLES.ZP_TV.ID.in_(
        #            session.query(TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID).filter(
        #                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID.in_(zp_entity_id_list),
        ...
        ).join(TABLES.ZP_TV_SEASON_RAW_IMAGE, and_(
            TABLES.ZP_TV_SEASON_RAW_IMAGE.SEASON == TABLES.ZP_TV_EPISODE.SEASON,
            TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID == TABLES.ZP_TV_EPISODE.ZP_TV_ID,
            TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_EAPI_ID == TABLES.ZP_TV_EAPI_EID.ZP_EAPI_ID
            )
        ).filter(
            TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID.in_(zp_entity_id_list),
        ...
        qry_tv_missing_raw_eapi_image = session.query(
            ...
            ~TABLES.ZP_TV.ID.in_(
                session.query(TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID).filter(
                    ...
                    TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID, TABLES.ZP_TV_SEASON_RAW_IMAGE.SEASON
                ).having(
                    func.count(TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_TYPE_ID) == len(zp_entity_id_list)
                )
            ),
    ...
    def check_missing_eapi_raw_images(self, zp_tv_id, eapi, zp_lang_id, zp_entity_id_list):
        session = self.Session()
        num_seasons = session.query(func.count(TABLES.ZP_TV_EPISODE.SEASON.distinct()).label('num_seasons')).filter(
            TABLES.ZP_TV_EPISODE.ZP_TV_ID == zp_tv_id
        ).one().num_seasons
        log.debug('num_seasons %s', num_seasons)
        try:
            session.query(
                TABLES.ZP_TV_SEASON_RAW_IMAGE.ZP_ENTITY_ID
            ).filter(
                ...
                func.count() == len(zp_entity_id_list) * num_seasons
            ).one()
        except orm.exc.NoResultFound:
            session.close()
            return True
                    ...
                    if hasattr(getattr(self, eapi), 'get_tv_season_raw_images'):
                        ...
                        for image_type in self.image_types_dict:
                            ...
                            if 'show' in eapi_supported_tv_images:
                                if isinstance(eapi_supported_tv_images['season'], list):
                                    if image_type in eapi_supported_tv_images['season']:
                            ...
                            if getattr(getattr(self, eapi), 'supported_tv_image_langs') is True:
                                ...
                                for zp_lang_id in user_langs:
                                    ...
                                    if self.check_can_retry(1) is True:
                                        log.debug('Retrying TV Season Raw Images')
                        ...
                        log.warning('eapi %s does not have get_tv_season_raw_images', eapi)
                else:
    ...
    def acquire_lang_images_no_retry(self, eapi, eapi_image_type_dict, eapi_image_type_id_list,
        ...
        while tv_processing_complete is False:
            zp_tv_list = self.get_tv_not_in_raw_eapi_image_no_retry(zp_tv_id, eapi, zp_lang_id,
                                                                     eapi_image_type_id_list)
            log.debug('zp_tv_list %s', zp_tv_list)
            # raise SystemExit
            if zp_tv_list:
                for zp_tv_list_id in zp_tv_list:
                    ...
                    # log.error('zp_tv_id %s, Season %s, zp_lang_id %s', zp_tv_id, season, zp_lang_id)
    ...
    def get_seasons_image_type_dict(self, zp_tv_id, eapi, zp_lang_id, eapi_image_type_dict, zp_tv_season_list):
        ...
        for season in zp_tv_season_list:
            if season in tv_season_not_missing_raw_eapi_images_dict:
                for image_type in eapi_image_type_dict:
                    if eapi_image_type_dict[image_type]['id'] not in tv_season_not_missing_raw_eapi_images_dict[season]:
                        if season not in seasons_image_type_dict:
                            seasons_image_type_dict[season] = {}
                        seasons_image_type_dict[season][image_type] = eapi_image_type_dict[image_type]
            else:
                seasons_image_type_dict[season] = {}
                for image_type in eapi_image_type_dict:
                    seasons_image_type_dict[season][image_type] = eapi_image_type_dict[image_type]
    ...
    def eapi_lang_images(self, eapi, zp_tv_id, zp_lang_id, eapi_image_type_dict,
        ...
        if zp_tv_eapi_eid is not None:
            zp_tv_season_list = self.get_tv_season_missing_raw_eapi_image(zp_tv_id, eapi, zp_lang_id,
                                                                          eapi_image_type_id_list)
            # raise SystemExit
            seasons_image_type_dict = self.get_seasons_image_type_dict(zp_tv_id, eapi, zp_lang_id,
                                                                       eapi_image_type_dict, zp_tv_season_list)
            log.debug('seasons_image_type_dict %s', seasons_image_type_dict)
            if zp_tv_season_list and seasons_image_type_dict:
                # raise SystemExit
                ...
                if make_dir(tv_raw_image_root_path):
                    ...
                    # raise SystemExit
                    self.acquire_tv_eapi_raw_images(zp_tv_id, zp_tv_season_list,
                                                    zp_lang_id,
                                                    eapi, zp_tv_eapi_eid,
                                                    seasons_image_type_dict,
                    ...
                    if self.check_missing_eapi_raw_images(zp_tv_id, eapi, zp_lang_id,
                        ...
                        self.set_retry(1, 10, zp_tv_id, self.eapi_dict[eapi], zp_lang_id)
                        if getattr(getattr(self, eapi), 'supported_tv_image_langs') is True:
                            zp_tv_season_list_missing = self.get_tv_season_missing_raw_eapi_image(zp_tv_id, eapi,
                                                                                                  zp_lang_id,
                                                                                                  eapi_image_type_id_list)
                            seasons_image_type_dict_missing = self.get_seasons_image_type_dict(zp_tv_id, eapi,
                                                                                               zp_lang_id,
                                                                                               eapi_image_type_dict,
                                                                                               zp_tv_season_list_missing)

                            zp_tv_season_list_missing_no_lang = self.get_tv_season_missing_raw_eapi_image(zp_tv_id,
                                                                                                          eapi,
                                                                                                          None,
                                                                                                          eapi_image_type_id_list)

                            seasons_image_type_dict_no_lang = self.get_seasons_image_type_dict(zp_tv_id, eapi, None,
                                                                                               eapi_image_type_dict,
                                                                                               zp_tv_season_list_missing_no_lang)
                            zp_tv_season_list = []
                            for season in zp_tv_season_list_missing_no_lang:
                                if season in zp_tv_season_list_missing:
                                    zp_tv_season_list.append(season)
                            seasons_image_type_dict = {}
                            for season in seasons_image_type_dict_no_lang:
                                if season in seasons_image_type_dict_missing:
                                    for image_type in seasons_image_type_dict_no_lang[season]:
                                        if image_type in seasons_image_type_dict_missing[season]:
                                            if season not in seasons_image_type_dict:
                                                seasons_image_type_dict[season] = {}
                                            seasons_image_type_dict[season][image_type] = \
                                                seasons_image_type_dict_missing[season][image_type]

                            log.debug('eapi_image_type_dict %s', eapi_image_type_dict)
                            log.debug('seasons_image_type_dict_missing %s', seasons_image_type_dict_missing)
                            log.debug('zp_tv_season_list_missing %s', zp_tv_season_list_missing)
                            log.debug('seasons_image_type_dict_no_lang %s', seasons_image_type_dict_no_lang)
                            log.debug('zp_tv_season_list_missing_no_lang %s', zp_tv_season_list_missing_no_lang)
                            log.debug('seasons_image_type_dict %s', seasons_image_type_dict)
                            log.debug('zp_tv_season_list %s', zp_tv_season_list)
                            # raise SystemExit
                            if zp_tv_season_list and seasons_image_type_dict:
    ...
    def acquire_tv_eapi_raw_images(self, zp_tv_id, zp_tv_season_list, zp_lang_id, eapi, zp_tv_eapi_eid,
        ...
        if hasattr(getattr(self, eapi), 'get_tv_season_raw_images'):
            ...
            if (iso_639_part1 is not None and zp_lang_id is not None) or \
                ...
                eapi_raw_iamges_dict = getattr(getattr(self, eapi), 'get_tv_season_raw_images')(
                    zp_tv_eapi_eid, zp_tv_season_list, iso_639_part1, seasons_image_type_dict)
                    ...
                    for season in seasons_image_type_dict:
                        if season in eapi_raw_iamges_dict:
                            ...
                            if make_dir(tv_season_raw_image_root_path):
                                ...
                                for image_type in seasons_image_type_dict[season]:
                                    if image_type in eapi_raw_iamges_dict[season]:
                                        if isinstance(eapi_raw_iamges_dict[season][image_type], dict):
                                            if 'image_reference' in eapi_raw_iamges_dict[season][image_type] and \
                                                    'image_url' in eapi_raw_iamges_dict[season][image_type]:
                                                log.debug('image_reference and image_url in %s',
                                                          eapi_raw_iamges_dict[season][image_type])
                                                image_reference = eapi_raw_iamges_dict[season][image_type][
                                                    'image_reference']
                                                image_reference_extension = get_file_extension(image_reference)
                                                if image_reference_extension in self.allowed_extension_list:
                                                    image_download_url = eapi_raw_iamges_dict[season][image_type][
                                                        'image_url']
                                                    if isinstance(image_reference, string_types) and isinstance(
                                                        ...
                                                        if download(image_download_url, new_tv_image_path) is True:
                                                            self.set_acquired_eapi_image(
                                                                seasons_image_type_dict[season][image_type]['id'],
                                                                eapi, zp_tv_id, season, zp_lang_id,
    ...
    def set_acquired_eapi_image(self, image_type_id, eapi, zp_tv_id, season, zp_lang_id, image_reference,
                                new_tv_image_filename):
        session = self.Session()
        try:
            ...
            add_zp_tv_raw_image = TABLES.ZP_TV_SEASON_RAW_IMAGE(ZP_ENTITY_TYPE_ID=image_type_id,
            ...
            log.error('there is allready an extry for ZP_TV_SEASON_RAW_IMAGE with ZP_ENTITY_TYPE_ID %s'
