...
class Artwork(ArtworkBase):
    ...
    def __init__(self, **kwargs):
        ...
        """
        self.specials = tv_episode_specials.Specials(self.Session, 'tv')
