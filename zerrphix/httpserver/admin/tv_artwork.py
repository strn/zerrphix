...
class Artwork(ArtworkBase):
    ...
    def __init__(self, **kwargs):
        ...
        """
        self.specials = tv_specials.Specials(self.Session, 'tv')
    ...
    def render(self, ZP_ENTITY_ID, ZP_USER_ID, image_type, zp_icon_sub_type_id):
        ...
        user_library_langs = self.get_user_library_langs(2,
                                                         kwargs['ZP_USER_ID'])
        #log.error('calling tv_artwork user_library_eapi_order')
        user_library_eapi_order = self.user_library_eapi_order(2,
                                                               kwargs['ZP_USER_ID'])
        kwargs['ZP_EAPI_ID_REQ'] = user_library_eapi_order[0]
        kwargs['ZP_LANG_ID_REQ'] = user_library_langs[0]
        kwargs['template_dict'] = {'template':
                                       evaluated_templates['library']['tv'][image_type]}
